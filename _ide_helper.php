 ...
 */
     ...
     */ 
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::formatName($data);
        }
...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function run($pendingTask)
        {
                        /** @var \ProtoneMedia\LaravelTaskRunner\TaskDispatcher $instance */
                        return $instance->run($pendingTask);
        }
                    /**
         ...
         * @static 
         */ 
        public static function fake($tasksToFake = [])
        {
                        /** @var \ProtoneMedia\LaravelTaskRunner\TaskDispatcher $instance */
                        return $instance->fake($tasksToFake);
        }
                    /**
         * Fake all or some tasks.
         *
         ...
         * @static 
         */ 
        public static function dontFake($taskToDispatch)
        {
                        /** @var \ProtoneMedia\LaravelTaskRunner\TaskDispatcher $instance */
                        return $instance->dontFake($taskToDispatch);
        }
                    /**
         ...
         * @static 
         */ 
        public static function preventStrayTasks($prevent = true)
        {
                        /** @var \ProtoneMedia\LaravelTaskRunner\TaskDispatcher $instance */
                        return $instance->preventStrayTasks($prevent);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function assertDispatched($taskClass, $additionalCallback = null)
        {
                        /** @var \ProtoneMedia\LaravelTaskRunner\TaskDispatcher $instance */
                        return $instance->assertDispatched($taskClass, $additionalCallback);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function assertNotDispatched($taskClass, $additionalCallback = null)
        {
                        /** @var \ProtoneMedia\LaravelTaskRunner\TaskDispatcher $instance */
                        return $instance->assertNotDispatched($taskClass, $additionalCallback);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function assertDispatchedTimes($taskClass, $times = 1, $additionalCallback = null)
        {
                        /** @var \ProtoneMedia\LaravelTaskRunner\TaskDispatcher $instance */
                        return $instance->assertDispatchedTimes($taskClass, $times, $additionalCallback);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function storePersistentFake()
        {
                        /** @var \ProtoneMedia\LaravelTaskRunner\TaskDispatcher $instance */
                        return $instance->storePersistentFake();
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function loadPersistentFake()
        {
                        /** @var \ProtoneMedia\LaravelTaskRunner\TaskDispatcher $instance */
                        return $instance->loadPersistentFake();
        }
...
namespace  { 
            ...
            class TaskRunner extends \ProtoneMedia\LaravelTaskRunner\Facades\TaskRunner {}
